...
def callback_minute(context):
    ...
    context.bot.send_message(chat_id=chat_id, text=generateOffense.generateOffense())

def start(update, context):
    context.bot.send_message(chat_id=update.message.chat_id, text="teste docker")
    ...
    if (update.message.text == "Oi Bender" or update.message.text == "oi bender" or
        ...
        text= "Oi, vamos tomar um Velho Fortran? Estou no Heroku agora!")
          ...
          "Muito bom" in update.message.text or "muito Bom" in update.message.text):
            context.bot.send_message(chat_id=update.effective_chat.id, 
                                     text= "Qualquer coisa abaixo da imortalidade e uma perda de tempo completa!")
          ...
          context.bot.send_message(chat_id=update.effective_chat.id, 
                                     text= "Como posso ser tao ruim em tudo que tento e ainda ser melhor que vocês?")
